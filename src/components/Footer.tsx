...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#2f4f4f] text-gray-200 pt-16 pb-8 mt-20">
      <div className="mx-auto max-w-7xl px-6 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
        {/* Cột 1 */}
        <div>
          <h3 className="text-lg font-bold text-white">Furni<span className="text-yellow-400">.</span></h3>
          <p className="mt-3 text-sm leading-relaxed">
            Nội thất hiện đại và tối giản, mang lại không gian sống tinh tế cho gia đình bạn.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/shop" className="hover:text-yellow-400">Sản phẩm</Link></li>
        ...
        <div>
          ...
          <div className="flex gap-4">
            <a href="#" className="hover:text-yellow-400"><Facebook className="h-5 w-5" /></a>
            <a href="#" className="hover:text-yellow-400"><Instagram className="h-5 w-5" /></a>
            <a href="#" className="hover:text-yellow-400"><Twitter className="h-5 w-5" /></a>
          </div>
