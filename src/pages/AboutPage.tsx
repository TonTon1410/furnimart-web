...
const AboutPage = () => {
  ...
  const values = [
    {
      ...
      description:
        "Chúng tôi đam mê tạo ra những sản phẩm nội thất đẹp và chức năng",
    },
    {
      icon: <Award className="w-8 h-8" />,
      title: "Chất lượng cao",
      description:
        "Sử dụng nguyên liệu tốt nhất và quy trình sản xuất nghiêm ngặt",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white pb-24 sm:pb-20">
      {/* Hero Section */}
      <section className="relative bg-linear-to-br from-emerald-50 to-emerald-100 pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-emerald-700 max-w-3xl mx-auto leading-relaxed">
              FurniMart - Website thương mại điện tử nội thất đa chi nhánh mang
              đến cho khách hàng trải nghiệm mua sắm hiện đại, trực quan và tiện
              lợi.
            </p>
          </motion.div>
        </div>
            ...
            <motion.div {...fadeInUp}>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  ...
                  và quan sát sản phẩm nội thất trong không gian 3D, giúp quyết
                  định mua sắm chính xác hơn so với hình ảnh 2D truyền thống. Và
                  kết hợp với ứng dụng Ả cung cấp những trải nghiệm mua sắm độc
                  đáo và tiện lợi.
                </p>
                <p>
                  Quản lý tồn kho đa chi nhánh: Website cho phép kiểm tra sản
                  phẩm còn hàng ở từng cửa hàng cụ thể, giúp khách hàng chọn địa
                  điểm mua thuận tiện.
                </p>
                <p>
                  Thanh toán trực tuyến an toàn: Tích hợp nhiều cổng thanh toán
                  như Momo, ZaloPay, SEPAY và Stripe.
                </p>
                <p>
                  Dịch vụ hậu mãi: Khách hàng có thể gửi yêu cầu đổi trả, bảo
                  hành hoặc lắp ráp trực tiếp trên website.
                </p>
              </div>
            </motion.div>
            <motion.div
      ...
      {/* CTA Section */}
      <section className="py-20 bg-linear-to-r from-emerald-600 to-emerald-700">
