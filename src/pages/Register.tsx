      ...
      >
        <div className="bg-white/95 backdrop-blur-sm p-8 rounded-[2rem] shadow-xl border border-emerald-100">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-extrabold text-gray-900 mb-2">Tạo tài khoản mới</h1>
            <p className="text-gray-600">
              Tham gia cộng đồng <span className="text-emerald-600 font-semibold">Nội thất</span> ngay hôm nay
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                className="mt-1 h-4 w-4 text-emerald-600 border-emerald-300 rounded focus:ring-emerald-500"
                required
              />
