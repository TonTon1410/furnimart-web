...
import { CheckCircle2, ImageIcon, Loader2, Tags, Type, AlignLeft } from "lucide-react";
...
const CategoryForm: React.FC<Props> = ({
  ...
  const canSubmit = useMemo(() => form.categoryName.trim().length >= 2, [form.categoryName]);
      ...
      >
        <div className="grid gap-5">
          <div>
            ...
            >
              <Tags className="h-4 w-4 text-emerald-600" /> Tên danh mục <span className="text-red-500">*</span>
            </label>
            <input
              id="categoryName"
              name="categoryName"
          ...
          <div>
            <label
              ...
              className="mb-1 inline-flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-200"
            >
              <ImageIcon className="h-4 w-4 text-emerald-600" /> Ảnh danh mục (URL)
            </label>
            <input
              id="image"
              name="image"
        ...
        <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-emerald-100 bg-emerald-50/40 dark:border-emerald-900/40 dark:bg-emerald-900/10">
            ...
            <div className="absolute bottom-4 left-4 text-white drop-shadow">
              ...
              <div className="text-xl font-bold">{form.categoryName || "(Chưa có tên)"}</div>
            </div>
          </div>
        </div>
      </aside>
