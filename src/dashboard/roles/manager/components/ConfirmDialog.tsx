...
interface ConfirmDialogProps {
  ...
  confirmLabel?: string;
  cancelLabel?: string;
  variant?: "danger" | "success" | "warning"; // Tùy chọn màu sắc cảnh báo
}
...
const ConfirmDialog: React.FC<ConfirmDialogProps> = ({
  ...
  cancelLabel = "Hủy bỏ",
  variant = "danger", // Mặc định là màu đỏ (nguy hiểm)
}) => {
  ...
  // Cấu hình màu sắc và icon dựa trên variant
  const styles = {
    danger: {
  ...
  return (
    <div className="fixed inset-0 z-9999 flex items-center justify-center p-4 sm:p-0">
      {/* Backdrop (Lớp nền mờ) - Thêm backdrop-blur để trông sang hơn */}
      <div
